...
<head>
    ...
    <title>Document CR2 Inbox</title> 
...
<table id="Doc_Table" class="table table-striped" style="width:100%;"  data-page-length='20'>
      ...
      <?php foreach ($files as $file): ?>
        <tr>
        <td width = "12%"><?php echo $file['Approver']; ?></td>
        ...
        <td><a href="view_dc2Inbox.php?page=view_file&id=<?php echo md5($file['id']) ?>">View</a></td>
        </tr>
    <?php endforeach;?>
      </tbody>
  </table>
