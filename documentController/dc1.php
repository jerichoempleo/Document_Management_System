...
<!-- <div class="container wrapper" style="margin-top: 20px;" id="auto"> -->
    ...
    <?php foreach ($files as $file): ?>
        ...
        <td><a href="view_document1.php?page=view_file&Revision_ID=<?php echo md5($file['Revision_ID']) ?>">View</a></td>
        </tr>
    <?php endforeach;?>
